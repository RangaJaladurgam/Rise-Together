      ...
      <div className="content">
        ...
        <div className="kyt-questions">
          <div className="question">
            ...
            <p className="answer">
              Answer: When the only specified item is welcome.html, the server
              still treats index.html as a backup. If not specified, the default
          ...
          <div className="question">
            <p>
              Q3. Which method is used to retrieve a form value in a JSP or
              Servlet?
            </p>
          ...
          <div className="question">
            <p>
              Q6. The _____ object is used to forward the request processing
          ...
          <div className="question">
            ...
            <p className="answer">
              Answer: The init() method is called when the servlet is first
              created.
            </p>
          </div>
          ...
          <div className="question">
            <p>
              Q8. Given request is an HttpServletRequest, which code snippets
              will create a session if one doesn't exist?
            </p>
          ...
          <div className="question">
            <p>
              Q9. Which of the following attribute is used to have uncaught
              run-time exceptions automatically forwarded to an error processing
              page?
            </p>
          ...
          <div className="question">
            <p>
              Q11. Which method of HttpServletResponse is used to redirect an
              HTTP request to another URL?
            </p>
          ...
          <div className="question">
            <p>
              Q12. Which of the following code is used to get a HTTP Session
              object in servlets?
            </p>
            <p className="answer">Answer: request.getSession()</p>
          </div>
          ...
          <div className="question">
            <p>
              Q13. How do you switch between Java code and HTML code in a jsp
              file?
            </p>
            <p className="answer">
              Answer: Java code is the default; HTML code is kept inside{" "}
              {` <% %> `} brackets.
            </p>
          </div>
          ...
          <div className="question">
            <p>
              Q17. What is the return type of getAttribute(String name) in
              ServletRequest?
            </p>
          ...
          <div className="question">
            <p>
              Q18. Which of the below methods returns a string containing
              information about the servlet, such as its author, version, and
              copyright?
            </p>
          ...
          <div className="question">
            <p>
              Q19. Which of the following attribute is used to mark a page as
          ...
          <div className="question">
            <p>
              Q20. Which of the following statement is not correct about HTTP
              method?
            </p>
            <p className="answer">
              Answer: A POST request appends data to the end of the URL
            </p>
          </div>
          ...
          <div className="question">
            <p>
              Q22. Choose the statement that best describes the relationship
              between JSP and servlets:
            </p>
            <p className="answer">
              Answer: Servlets are built on JSP semantics, and all servlets are
          ...
          <div className="question">
            <p>
              Q23. Which tag in the JSP is used to define a page as an error
              page?
            </p>
          ...
          <div className="question">
            <p>
              Q24. Which of these classes define the getWriter() method that
              returns an object of type PrintWriter?
            </p>
          ...
          <div className="question">
            <p>
              Q25. Consider the following JSP page with an error in the Java
              code. What will happen when we try to access this JSP file on the
              server?
            </p>
            <p className="answer">
              Answer: The page will load normally, and the Java errors which
              happen will be skipped.
            </p>
          </div>
          ...
          <div className="question">
            <p>
              Q28. Which of the following is true about the Initialization phase
              in JSP life cycle?
            </p>
            <p className="answer">
              Answer: When a container loads a JSP, it invokes the jspInit()
          ...
          <div className="question">
            <p>
              Q30. If no method attribute is specified in a form tag, what
